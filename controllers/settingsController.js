...
exports.getSettings = async (req, res) => {
    try {
        ...
        const user = await User.findById(ownerId).select("name email phone customUrl isUrlActive");
...
exports.updateSettings = async (req, res) => {
    try {
        const ownerId = getOwnerId(req.user);
        const { customUrl, isUrlActive, validateOnly } = req.body;
